(function(){
	...
	function getIndexDay(){
		...
		//下月数据
		for( var j = 0;j<(35 - calendarDate.days - calendarDate.monthStart);j++ ){//32-已占用表格数=剩余表格数
	...
	$.fn.extend({
	    calendar:function(opt){
	        ...
	        $('.ht-rili-date').html(calendarDate.year+'       '+calendarDate.month+'月');
